...
const WARDROBE_DATA = [
  ...
  {id:"o7",name:"Raphael Jacket",brand:"ORTTU",color:"Pink",size:"L",cat:"Jacket",type:"outer",style:"Contrast",stats:{drama:3,structure:3,skin:1,edge:2,formality:3}},
  ...
  {id:"o10",name:"Star Neck Lace Shirt",brand:"ORTTU",color:"Off-White",size:"M",cat:"Shirt",type:"top",style:"Contrast",stats:{drama:4,structure:2,skin:1.5,edge:3,formality:4}},
  ...
  {id:"o12",name:"Jesse Top with Scarf",brand:"ORTTU",color:"Black",size:"XL",cat:"Top",type:"top",style:"Dark / Minimal",stats:{drama:4,structure:3,skin:3,edge:3,formality:2}},
  ...
  {id:"o18",name:"Star Neck Cardigan Sleeveless",brand:"ORTTU",color:"Green",size:"XL",cat:"Cardigan",type:"top",style:"Contrast",stats:{drama:4,structure:2,skin:2,edge:3,formality:3}},
  // ── Minoar ─────────────────────────────────────────────────────────────────
  ...
  {id:"m4",name:"Layered Sleeveless Collar Shirt",brand:"MINOAR",color:"Black",size:"L",cat:"Shirt",type:"top",style:"Dark / Minimal",stats:{drama:4,structure:4,skin:2,edge:4,formality:3}},
  {id:"m5",name:"Layered Sleeveless White Collar Shirt",brand:"MINOAR",color:"White",size:"L",cat:"Shirt",type:"top",style:"Dark / Minimal",stats:{drama:3,structure:4,skin:2,edge:3,formality:3}},
  {id:"m6",name:"Sleeveless Collar Shirt",brand:"MINOAR",color:"Black",size:"L",cat:"Shirt",type:"top",style:"Tonal",stats:{drama:3,structure:3,skin:2,edge:3,formality:3}},
  ...
  {id:"m8",name:"Trigon Layered Sleeveless Shirt",brand:"MINOAR",color:"Black",size:"L",cat:"Shirt",type:"top",style:"Dark / Minimal",stats:{drama:4,structure:4,skin:2,edge:4,formality:3}},
  ...
  {id:"m13",name:"Division Cut Linear Collar Shirt",brand:"MINOAR",color:"White",size:"L",cat:"Shirt",type:"top",style:"Contrast",url:"https://www.minoar.com/product/division-cut-linear-collar-shirt-2/",stats:{drama:4,structure:4,skin:1.5,edge:4,formality:4}},
  {id:"m14",name:"Fiber Bond Magma Tech Hood Cardigan",brand:"MINOAR",color:"Black",size:"L",cat:"Cardigan",type:"outer",style:"Dark / Minimal",stats:{drama:4,structure:4,skin:1,edge:5,formality:2.5}},
  ...
  {id:"m16",name:"Hexa Long Layers Sleeveless Coat",brand:"MINOAR",color:"Black",size:"L",cat:"Coat",type:"outer",style:"Dark / Minimal",stats:{drama:5,structure:5,skin:3,edge:5,formality:3.5}},
  ...
  {id:"r3",name:"Obscure Cloak Fringe Crop Top",brand:"RYVK",color:"Black/Gold",size:"OS",cat:"Crop Top",type:"top",style:"Night Out",url:"https://ryvkstudio.com/products/obscure-cloak-fringe-crop-top",stats:{drama:5,structure:3,skin:5,edge:5,formality:2}},
  ...
  // ── FRKM SCD ───────────────────────────────────────────────────────────────
  {id:"f1",name:"25FW Layered Belt Apron Skirt",brand:"FRKM",color:"Black",size:"OS",cat:"Skirt",type:"bottom",style:"Dark / Minimal",stats:{drama:5,structure:4,skin:3,edge:5,formality:1}},
  // ── YA|SAR ─────────────────────────────────────────────────────────────────
  ...
  // ── ARAHANT ────────────────────────────────────────────────────────────────
  {id:"a1",name:"Magi Sentient Robe",brand:"ARAHANT",color:"Black",size:"OS",cat:"Robe",type:"outer",style:"Dark / Minimal",stats:{drama:5,structure:2,skin:2,edge:5,formality:3}},
  // ── Jewelry — CRAFTD London ────────────────────────────────────────────────
  {id:"c1",name:"Rope Wrap Ring",brand:"CRAFTD",color:"Gold",size:"L",cat:"Ring",type:"accessory",style:"Contrast",url:"https://craftdlondon.com/products/rope-wrap-ring-gold",versatile:true,stats:{drama:2,structure:1,skin:1,edge:2,formality:2}},
  {id:"c2",name:"Matte Onyx Stone Bracelet",brand:"CRAFTD",color:"Gold",size:"22cm",cat:"Bracelet",type:"accessory",style:"Contrast",url:"https://craftdlondon.com/products/matte-onyx-stone-bracelet-gold",versatile:true,stats:{drama:2,structure:1,skin:1,edge:2,formality:2}},
  {id:"c3",name:"Double Belcher Bracelet",brand:"CRAFTD",color:"Gold",size:"7.5in",cat:"Bracelet",type:"accessory",style:"Contrast",url:"https://craftdlondon.com/products/double-belcher-bracelet-gold",versatile:true,stats:{drama:2,structure:1,skin:1,edge:2,formality:2}},
  // ── Jewelry — Gasper ───────────────────────────────────────────────────────
  {id:"g1",name:"Rope + Cuban Bracelet Set",brand:"GASPER",color:"Gold",size:"8in",cat:"Bracelet",type:"accessory",style:"Contrast",url:"https://gasper.co",versatile:true,stats:{drama:2,structure:1,skin:1,edge:2,formality:2}},
  {id:"g2",name:"Lapis Set",brand:"GASPER",color:"Gold",size:"OS",cat:"Necklace Set",type:"accessory",style:"Contrast",url:"https://gasper.co/products/set-lapis",versatile:true,stats:{drama:3,structure:2,skin:1,edge:3,formality:3}},
  ...
  {id:"g3",name:"Touch of God Cuff",brand:"GASPER",color:"Gold",size:"OS",cat:"Cuff",type:"accessory",style:"Contrast",url:"https://gasper.co/products/creation-of-adam-cuff",versatile:true,stats:{drama:4,structure:2,skin:1,edge:4,formality:3}},
  {id:"g4",name:"Square Onyx Ring",brand:"GASPER",color:"Gold",size:"11",cat:"Ring",type:"accessory",style:"Contrast",url:"https://gasper.co/products/square-onyx-ring",versatile:true,stats:{drama:3,structure:2,skin:1,edge:3,formality:3}},
  {id:"g5",name:"Touch of God Ring",brand:"GASPER",color:"Gold",size:"8",cat:"Ring",type:"accessory",style:"Contrast",url:"https://gasper.co/products/touch-of-god-ring",versatile:true,stats:{drama:3,structure:2,skin:1,edge:3,formality:3}},
  {id:"g6",name:"Havana Ring",brand:"GASPER",color:"Gold",size:"8",cat:"Ring",type:"accessory",style:"Contrast",url:"https://gasper.co/products/havana",versatile:true,stats:{drama:2,structure:1,skin:1,edge:2,formality:2}},
  // ── Jewelry — Dernholt Stockholm ──────────────────────────────────────────
  {id:"d1",name:"Svart Sten Braided Chain",brand:"DERNHOLT",color:"Black/Gold",size:"OS",cat:"Necklace",type:"accessory",style:"Contrast",url:"https://dernholt.com",versatile:true,stats:{drama:3,structure:2,skin:1,edge:3,formality:3}},
  {id:"d2",name:"Battle Rope Bracelet",brand:"DERNHOLT",color:"Gold/Silver",size:"OS",cat:"Bracelet",type:"accessory",style:"Contrast",url:"https://dernholt.com",versatile:true,stats:{drama:3,structure:2,skin:1,edge:3,formality:3}},
  {id:"d3",name:"Gold Body Chain and Necklace Set",brand:"DERNHOLT",color:"Gold",size:"OS",cat:"Body Chain",type:"accessory",style:"Contrast",url:"https://dernholt.com",stats:{drama:4,structure:2,skin:4,edge:3,formality:3}},
  // ── Shoes — SASAIA ─────────────────────────────────────────────────────────
  ...
  {id:"c8",name:"Dagger Earring",brand:"CRAFTD",color:"Gold",size:"Pair",cat:"Earring",type:"accessory",style:"Contrast",url:"https://craftdlondon.com/products/dagger-earring-gold",versatile:true,stats:{drama:3,structure:1,skin:2,edge:3,formality:3}},
  {id:"c9",name:"Crown Ring",brand:"CRAFTD",color:"Gold",size:"M",cat:"Ring",type:"accessory",style:"Contrast",url:"https://craftdlondon.com/products/crown-ring-gold",versatile:true,stats:{drama:3,structure:2,skin:1,edge:3,formality:3}},
  {id:"c10",name:"Wing Gift Set",brand:"CRAFTD",color:"Gold",size:"L/XL",cat:"Set",type:"accessory",style:"Contrast",url:"https://craftdlondon.com/products/wing-gift-set-gold",versatile:true,stats:{drama:3,structure:1,skin:1,edge:3,formality:3}},
  {id:"c11",name:"Wheat Chain",brand:"CRAFTD",color:"Gold",size:"OS",cat:"Necklace",type:"accessory",style:"Contrast",url:"https://craftdlondon.com/products/wing-gift-set-gold",versatile:true,stats:{drama:2,structure:1,skin:1,edge:2,formality:2}},
  {id:"c12",name:"Wheat Bracelet",brand:"CRAFTD",color:"Gold",size:"L/XL",cat:"Bracelet",type:"accessory",style:"Contrast",url:"https://craftdlondon.com/products/wing-gift-set-gold",versatile:true,stats:{drama:2,structure:1,skin:1,edge:2,formality:2}},
  // ── Jewelry — CRAFTD order #925813 ────────────────────────────────────────
  {id:"c4",name:"Antique Ring",brand:"CRAFTD",color:"Gold",size:"L",cat:"Ring",type:"accessory",style:"Contrast",url:"https://craftdlondon.com/products/antique-ring-gold",versatile:true,stats:{drama:3,structure:2,skin:1,edge:3,formality:3}},
  {id:"c5",name:"Arrow Pendant",brand:"CRAFTD",color:"Gold",size:"OS",cat:"Pendant",type:"accessory",style:"Contrast",url:"https://craftdlondon.com/products/arrow-gold",versatile:true,stats:{drama:3,structure:1,skin:1,edge:3,formality:3}},
  {id:"c6",name:"Wing Pendant",brand:"CRAFTD",color:"Gold",size:"OS",cat:"Pendant",type:"accessory",style:"Contrast",url:"https://craftdlondon.com/products/wing-gold",versatile:true,stats:{drama:3,structure:1,skin:1,edge:3,formality:3}},
  {id:"c7",name:"Onyx Clover Stone Bracelet",brand:"CRAFTD",color:"Gold",size:"8.5in",cat:"Bracelet",type:"accessory",style:"Contrast",url:"https://craftdlondon.com/products/onyx-clover-stone-bracelet-gold",versatile:true,stats:{drama:2,structure:1,skin:1,edge:2,formality:2}},

  // Tops — Oversized Drop Shoulder Tee (Amazon) x3
  {id:"hd1",name:"Mature Photo Tee",brand:"HILARYDUFF",color:"Black",size:"L",cat:"T-Shirt",type:"top",url:"https://shop.hilaryduff.com/products/mature-photo-tee",stats:{drama:3,structure:1,skin:1,edge:2,formality:1}},
  ...
  {id:"am4",name:"Rhinestone Mesh Crop Shirt",brand:"AMAZON",color:"Black",size:"L",cat:"Shirt",type:"top",url:"https://www.amazon.com/dp/B0CDG4DY4H",stats:{drama:4.5,structure:1,skin:5,edge:4,formality:1}},
  ...
  {id:"am7",name:"Cable Knit Sweater Vest Burgundy",brand:"AMAZON",color:"Burgundy",size:"S",cat:"Vest",type:"top",url:"https://www.amazon.com/dp/B0FHTQV7RM",stats:{drama:2,structure:2,skin:1,edge:1,formality:3.5}},
  {id:"am8",name:"Cable Knit Sweater Vest Apricot",brand:"AMAZON",color:"Apricot",size:"L",cat:"Vest",type:"top",url:"https://www.amazon.com/dp/B0DGXZBYCP",stats:{drama:2,structure:2,skin:1,edge:1,formality:3.5}},
  {id:"am9",name:"Fishnet Mock Neck Vest",brand:"AMAZON",color:"Black",size:"XL",cat:"Tank",type:"top",url:"https://www.amazon.com/dp/B0CT2NXSJ4",stats:{drama:3.5,structure:1,skin:5,edge:4,formality:1}},
  ...
  // ── MUAZOE ───────────────────────────────────────────────────────────────────
  {id:"mz1",name:"Raye Print Round Neck T-shirt",brand:"MUAZOE",color:"Brown",size:"L",cat:"T-Shirt",type:"top",style:"Tonal",url:"https://www.muazoe.com/products/raye-print-round-neck-t-shirt-15",stats:{drama:3,structure:1,skin:1,edge:2,formality:1}},
  {id:"mz2",name:"Kanye West Print Round Neck T-shirt",brand:"MUAZOE",color:"Grey",size:"L",cat:"T-Shirt",type:"top",style:"Tonal",url:"https://www.muazoe.com/products/kanye-west-print-round-neck-t-shirt-20",stats:{drama:3,structure:1,skin:1,edge:2,formality:1}},
  {id:"u1",name:"Gold Dragon Cuff",brand:"UNBRANDED",color:"Gold",size:"OS",cat:"Cuff",type:"accessory",style:"Contrast",versatile:true,url:"https://www.ebay.com/itm/317008146557",stats:{drama:4,structure:2,skin:1,edge:4,formality:3}},
  {id:"dc1",name:"Neptune-210 Platform Boots",brand:"DEMONIA",color:"Black",size:"EU 44",cat:"Boots",type:"shoes",style:"Dark / Minimal",url:"https://demoniacult.com/products/neptune-210bvl",stats:{drama:5,structure:5,skin:1,edge:5,formality:2}},
];
