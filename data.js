...
const WARDROBE_DATA = [
  // ── Orttu ──────────────────────────────────────────────────────────────────
  {id:"o1",name:"New York Jersey Pants",brand:"ORTTU",color:"Black",size:"XL",cat:"Pants",type:"bottom",style:"Contrast",stats:{drama:0,structure:1,skin:0,edge:0,formality:2}},
  {id:"o2",name:"Brunello Pants",brand:"ORTTU",color:"Black",size:"M",cat:"Pants",type:"bottom",style:"Dark / Minimal",stats:{drama:0.5,structure:3,skin:0,edge:0,formality:4}},
  {id:"o3",name:"Roberto Pants",brand:"ORTTU",color:"Grey",size:"M",cat:"Pants",type:"bottom",style:"Tonal",stats:{drama:1,structure:3,skin:0,edge:0,formality:4},styling:["high-waist"]},
  {id:"o4",name:"Roberto Jacket",brand:"ORTTU",color:"Grey",size:"XXL",cat:"Jacket",type:"outer",style:"Tonal",stats:{drama:2,structure:3,skin:0,edge:0,formality:4}},
  {id:"o5",name:"Porto Long Shirt",brand:"ORTTU",color:"Olive",size:"OS",cat:"Shirt",type:"top",style:"Tonal",stats:{drama:2,structure:1,skin:0,edge:0,formality:3}},
  {id:"o6",name:"Raphael Shirt",brand:"ORTTU",color:"Pink",size:"L",cat:"Shirt",type:"top",style:"Contrast",stats:{drama:2,structure:2,skin:0,edge:0,formality:3.5}},
  {id:"o7",name:"Raphael Jacket",brand:"ORTTU",color:"Pink",size:"L",cat:"Jacket",type:"outer",style:"Contrast",stats:{drama:2,structure:3,skin:0,edge:0,formality:4}},
  {id:"o8",name:"Addams Skirt",brand:"ORTTU",color:"Black",size:"S",cat:"Skirt",type:"bottom",style:"Dark / Minimal",stats:{drama:2,structure:2,skin:2,edge:0,formality:3},styling:["high-waist"]},
  {id:"o9",name:"Emanuel Shirt",brand:"ORTTU",color:"Off-White",size:"M",cat:"Shirt",type:"top",style:"Dark / Minimal",stats:{drama:1,structure:2,skin:1,edge:0,formality:3}},
  {id:"o10",name:"Star Neck Lace Shirt",brand:"ORTTU",color:"Off-White",size:"M",cat:"Shirt",type:"top",style:"Contrast",stats:{drama:3,structure:1,skin:1.5,edge:0,formality:1}},
  {id:"o11",name:"Walker Denim Skirt",brand:"ORTTU",color:"Blue",size:"S",cat:"Skirt",type:"bottom",style:"Contrast",stats:{drama:2,structure:2,skin:2,edge:1,formality:2},styling:["high-waist"]},
  {id:"o12",name:"Jesse Top with Scarf",brand:"ORTTU",color:"Black",size:"XL",cat:"Top",type:"top",style:"Dark / Minimal",stats:{drama:3,structure:1,skin:3,edge:0,formality:2}},
  {id:"o13",name:"Christian Shirt",brand:"ORTTU",color:"Black",size:"M",cat:"Shirt",type:"top",style:"Dark / Minimal",stats:{drama:1,structure:2,skin:1,edge:0,formality:2.5}},
  {id:"o14",name:"Cambridge Skirt",brand:"ORTTU",color:"White",size:"S",cat:"Skirt",type:"bottom",style:"Dark / Minimal",stats:{drama:2,structure:2,skin:2,edge:0,formality:3},styling:["high-waist"]},
  {id:"o15",name:"Alejandro Cardigan",brand:"ORTTU",color:"Black",size:"OS",cat:"Cardigan",type:"outer",style:"Dark / Minimal",stats:{drama:2,structure:1,skin:4,edge:0,formality:2}},
  {id:"o16",name:"Star Neck Shirt Couture",brand:"ORTTU",color:"Beige",size:"L",cat:"Shirt",type:"top",style:"Tonal",stats:{drama:3,structure:3,skin:2,edge:0,formality:4}},
  {id:"o17",name:"Garson Pants",brand:"ORTTU",color:"Ivory",size:"L",cat:"Pants",type:"bottom",style:"Tonal",stats:{drama:0,structure:3,skin:1,edge:0,formality:2.5}},
  {id:"o18",name:"Star Neck Cardigan Sleeveless",brand:"ORTTU",color:"Green",size:"XL",cat:"Cardigan",type:"top",style:"Contrast",stats:{drama:3,structure:1,skin:3.5,edge:0,formality:2}},
  // ── Minoar ─────────────────────────────────────────────────────────────────
  {id:"m1",name:"Aspect Layered Construct Skirt Trousers",brand:"MINOAR",color:"Black",size:"L",cat:"Skirt-Trouser",type:"bottom",style:"Tonal",stats:{drama:4,structure:4,skin:0,edge:2,formality:3.5}},
  {id:"m2",name:"Quark Linen Cargo Layered Skirt Trousers",brand:"MINOAR",color:"Natural",size:"L",cat:"Skirt-Trouser",type:"bottom",style:"Contrast",stats:{drama:3,structure:3,skin:0,edge:2,formality:3}},
  {id:"m3",name:"Aspect Ripstop Alternated Trousers",brand:"MINOAR",color:"Black",size:"L",cat:"Trousers",type:"bottom",style:"Dark / Minimal",stats:{drama:3,structure:3,skin:0,edge:3,formality:3}},
  {id:"m4",name:"Layered Sleeveless Collar Shirt",brand:"MINOAR",color:"Black",size:"L",cat:"Shirt",type:"top",style:"Dark / Minimal",stats:{drama:3,structure:3,skin:2,edge:2,formality:3}},
  {id:"m5",name:"Layered Sleeveless White Collar Shirt",brand:"MINOAR",color:"White",size:"L",cat:"Shirt",type:"top",style:"Dark / Minimal",stats:{drama:2,structure:3,skin:2,edge:2,formality:3}},
  {id:"m6",name:"Sleeveless Collar Shirt",brand:"MINOAR",color:"Black",size:"L",cat:"Shirt",type:"top",style:"Tonal",stats:{drama:2,structure:3,skin:2,edge:2,formality:3}},
  {id:"m7",name:"Elongated Trigon Shirt",brand:"MINOAR",color:"White",size:"XL",cat:"Shirt",type:"top",style:"Dark / Minimal",stats:{drama:3,structure:3,skin:2,edge:2,formality:4}},
  {id:"m8",name:"Trigon Layered Sleeveless Shirt",brand:"MINOAR",color:"Black",size:"L",cat:"Shirt",type:"top",style:"Dark / Minimal",stats:{drama:3,structure:3,skin:2,edge:2,formality:3}},
  {id:"m9",name:"Trigon Black Layers Volume Pants",brand:"MINOAR",color:"Black",size:"L",cat:"Pants",type:"bottom",style:"Dark / Minimal",stats:{drama:3,structure:3,skin:0,edge:2,formality:4},styling:["high-waist"]},
  {id:"m10",name:"Trigon Layered Linen Trousers",brand:"MINOAR",color:"Grey",size:"L",cat:"Trousers",type:"bottom",style:"Tonal",stats:{drama:3,structure:2,skin:0,edge:1,formality:4},styling:["high-waist"]},
  {id:"m11",name:"Wide Layered Crushed Cropped Pants",brand:"MINOAR",color:"Black",size:"L",cat:"Pants",type:"bottom",style:"Contrast",stats:{drama:3,structure:2,skin:0,edge:2,formality:2.5},styling:["high-waist"]},
  {id:"m12",name:"Graphite External Bias Cargo Trousers",brand:"MINOAR",color:"Graphite",size:"L",cat:"Trousers",type:"bottom",style:"Contrast",stats:{drama:2,structure:3,skin:0,edge:3,formality:2}},
  ...
  {id:"m20",name:"Nuance Dyed Refract Segment Track Pants",brand:"MINOAR",color:"Grey",size:"L",cat:"Pants",type:"bottom",style:"Dark / Minimal",stats:{drama:2,structure:2,skin:0,edge:2,formality:1.5}},
  {id:"m21",name:"Cargo Asymmetric Skirt",brand:"MINOAR",color:"Black",size:"L",cat:"Skirt",type:"bottom",style:"Dark / Minimal",url:"https://www.minoar.com/product/cargo-men-skirt/",stats:{drama:3,structure:3,skin:0,edge:3,formality:2}},
  // ── RYVK Studio ────────────────────────────────────────────────────────────
  ...
  {id:"c3",name:"Double Belcher Bracelet",brand:"CRAFTD",color:"Gold",size:"7.5in",cat:"Bracelet",type:"accessory",style:"Contrast",url:"https://craftdlondon.com/products/double-belcher-bracelet-gold",versatile:true,stats:{drama:0,structure:0,skin:0,edge:0,formality:2}},
  // ── Jewelry — Gasper ───────────────────────────────────────────────────────
  {id:"g1",name:"Rope + Cuban Bracelet Set",brand:"GASPER",color:"Gold",size:"8in",cat:"Bracelet",type:"accessory",style:"Contrast",url:"https://gasper.co",versatile:true,stats:{drama:0,structure:0,skin:0,edge:0,formality:2}},
  {id:"g2",name:"Lapis Set",brand:"GASPER",color:"Gold",size:"OS",cat:"Necklace Set",type:"accessory",style:"Contrast",url:"https://gasper.co/products/set-lapis",versatile:true,stats:{drama:1,structure:0,skin:0,edge:0,formality:2}},
  // ── Tops — Techwear Official ───────────────────────────────────────────────
  {id:"tw1",name:"Japanese Relaxed Standing Collar Techwear Shirt",brand:"TECHWEAR",color:"Black",size:"OS",cat:"Shirt",type:"top",style:"Dark / Minimal",url:"https://techwearofficial.com/products/japanese-relaxed-standing-collar-techwear-shirt",stats:{drama:2,structure:2,skin:0,edge:3,formality:3}},
  {id:"z1",name:"Tunic Button-Up Collared Sleeveless",brand:"ZARA",color:"Black",size:"M (worn as men's)",cat:"Top",type:"top",style:"Dark / Minimal",url:"https://poshmark.com/listing/Zara-Woman-Womens-Tunic-ButtonUp-Collared-Sleeveless-Black-Polyester-Size-M-6a39a0ec4ba08a69d71db0a4",stats:{drama:3,structure:2,skin:2,edge:0,formality:1}},
  {id:"z2",name:"Relaxed Fit Interlock T-Shirt",brand:"ZARA",color:"Khaki",size:"M",cat:"T-Shirt",type:"top",style:"Tonal",url:"https://www.zara.com/us/en/relaxed-fit-interlock-t-shirt--04-p05584471.html",stats:{drama:0,structure:0,skin:0,edge:0,formality:1}},
  // ── Kids of Eden ───────────────────────────────────────────────────────────
  {id:"koe1",name:"Protanopia Cloak Hoodie",brand:"KOE",color:"Brown",size:"L",cat:"Hoodie",type:"outer",style:"Tonal",img:"https://cdn.shopify.com/s/files/1/0620/3880/2614/products/KIDSOFEDENHEAVYWEIGHTHOODIEMEN_STAUPEFRONT-636740.jpg?v=1683087494",url:"https://kidsofeden.earth/products/protanopia-cloak-hoodie-dust",stats:{drama:2,structure:1,skin:0,edge:1,formality:1}},
  // ── Shoes — Infinitys-Store ────────────────────────────────────────────────
  {id:"pw1",name:"Pai-Weite High-Top Sneakers White",brand:"JAKCUZ",color:"White",size:"45",cat:"Sneakers",type:"shoes",style:"Contrast",url:"https://www.amazon.com/dp/B098QKSBBY",stats:{drama:0,structure:2,skin:0,edge:1,formality:1}},
  {id:"pw2",name:"Pai-Weite High-Top Sneakers Black",brand:"JAKCUZ",color:"Black",size:"45",cat:"Sneakers",type:"shoes",style:"Dark / Minimal",url:"https://www.amazon.com/dp/B098QN5GBW",stats:{drama:0,structure:2,skin:0,edge:1,formality:1}},
  // ── Jewelry — Gasper order #96050 ─────────────────────────────────────────
  {id:"g3",name:"Touch of God Cuff",brand:"GASPER",color:"Gold",size:"OS",cat:"Cuff",type:"accessory",style:"Contrast",url:"https://gasper.co/products/creation-of-adam-cuff",versatile:true,stats:{drama:3,structure:1,skin:0,edge:2,formality:2}},
  {id:"g4",name:"Square Onyx Ring",brand:"GASPER",color:"Gold",size:"11",cat:"Ring",type:"accessory",style:"Contrast",url:"https://gasper.co/products/square-onyx-ring",versatile:true,stats:{drama:1,structure:0,skin:0,edge:0,formality:2}},
  {id:"g5",name:"Touch of God Ring",brand:"GASPER",color:"Gold",size:"8",cat:"Ring",type:"accessory",style:"Contrast",url:"https://gasper.co/products/touch-of-god-ring",versatile:true,stats:{drama:1,structure:0,skin:0,edge:1,formality:2}},
  {id:"g6",name:"Havana Ring",brand:"GASPER",color:"Gold",size:"8",cat:"Ring",type:"accessory",style:"Contrast",url:"https://gasper.co/products/havana",versatile:true,stats:{drama:0,structure:0,skin:0,edge:0,formality:2}},
  // ── Jewelry — Dernholt Stockholm ──────────────────────────────────────────
  {id:"d1",name:"Svart Sten Braided Chain",brand:"DERNHOLT",color:"Black/Gold",size:"OS",cat:"Necklace",type:"accessory",style:"Contrast",url:"https://dernholt.com",versatile:true,stats:{drama:1,structure:0,skin:0,edge:1,formality:2}},
  {id:"d2",name:"Battle Rope Bracelet",brand:"DERNHOLT",color:"Gold/Silver",size:"OS",cat:"Bracelet",type:"accessory",style:"Contrast",url:"https://dernholt.com",versatile:true,stats:{drama:1,structure:0,skin:0,edge:1,formality:2}},
  {id:"d3",name:"Gold Body Chain and Necklace Set",brand:"DERNHOLT",color:"Gold",size:"OS",cat:"Body Chain",type:"accessory",style:"Contrast",url:"https://dernholt.com",stats:{drama:3,structure:0,skin:4,edge:2,formality:0}},
  // ── Shoes — SASAIA ─────────────────────────────────────────────────────────
  {id:"s1",name:"Roman Fabric Boots",brand:"SASAIA",color:"Black",size:"44",cat:"Boots",type:"shoes",style:"Dark / Minimal",url:"https://sasaia.com",stats:{drama:2,structure:3,skin:0,edge:2,formality:3}},
  {id:"tv1",name:"AJ1131 Chelsea Boots",brand:"TOGAVIRILIS",color:"Black",size:"IT 44",cat:"Boots",type:"shoes",style:"Dark / Minimal",url:"https://www.ssense.com/en-us/men",stats:{drama:3,structure:4,skin:0,edge:3,formality:4}},
  {id:"dm1",name:"DMXL Zip Leather Chelsea Boots",brand:"DRMARTENS",color:"Black",size:"UK 10",cat:"Boots",type:"shoes",style:"Dark / Minimal",url:"https://www.drmartens.com",stats:{drama:2,structure:4,skin:0,edge:3,formality:3}},
  {id:"c8",name:"Dagger Earring",brand:"CRAFTD",color:"Gold",size:"Pair",cat:"Earring",type:"accessory",style:"Contrast",url:"https://craftdlondon.com/products/dagger-earring-gold",versatile:true,stats:{drama:1,structure:0,skin:0,edge:2,formality:1}},
  {id:"c9",name:"Crown Ring",brand:"CRAFTD",color:"Gold",size:"M",cat:"Ring",type:"accessory",style:"Contrast",url:"https://craftdlondon.com/products/crown-ring-gold",versatile:true,stats:{drama:1,structure:0,skin:0,edge:1,formality:2}},
  {id:"c10",name:"Wing Gift Set",brand:"CRAFTD",color:"Gold",size:"L/XL",cat:"Set",type:"accessory",style:"Contrast",url:"https://craftdlondon.com/products/wing-gift-set-gold",versatile:true,stats:{drama:1,structure:0,skin:0,edge:0,formality:2}},
  {id:"c11",name:"Wheat Chain",brand:"CRAFTD",color:"Gold",size:"OS",cat:"Necklace",type:"accessory",style:"Contrast",url:"https://craftdlondon.com/products/wing-gift-set-gold",versatile:true,stats:{drama:0,structure:0,skin:0,edge:0,formality:2}},
  {id:"c12",name:"Wheat Bracelet",brand:"CRAFTD",color:"Gold",size:"L/XL",cat:"Bracelet",type:"accessory",style:"Contrast",url:"https://craftdlondon.com/products/wing-gift-set-gold",versatile:true,stats:{drama:0,structure:0,skin:0,edge:0,formality:2}},
  // ── Jewelry — CRAFTD order #925813 ────────────────────────────────────────
  {id:"c4",name:"Antique Ring",brand:"CRAFTD",color:"Gold",size:"L",cat:"Ring",type:"accessory",style:"Contrast",url:"https://craftdlondon.com/products/antique-ring-gold",versatile:true,stats:{drama:1,structure:0,skin:0,edge:0,formality:2}},
  {id:"c5",name:"Arrow Pendant",brand:"CRAFTD",color:"Gold",size:"OS",cat:"Pendant",type:"accessory",style:"Contrast",url:"https://craftdlondon.com/products/arrow-gold",versatile:true,stats:{drama:1,structure:0,skin:0,edge:0,formality:2}},
  {id:"c6",name:"Wing Pendant",brand:"CRAFTD",color:"Gold",size:"OS",cat:"Pendant",type:"accessory",style:"Contrast",url:"https://craftdlondon.com/products/wing-gold",versatile:true,stats:{drama:1,structure:0,skin:0,edge:0,formality:2}},
  {id:"c7",name:"Onyx Clover Stone Bracelet",brand:"CRAFTD",color:"Gold",size:"8.5in",cat:"Bracelet",type:"accessory",style:"Contrast",url:"https://craftdlondon.com/products/onyx-clover-stone-bracelet-gold",versatile:true,stats:{drama:0,structure:0,skin:0,edge:0,formality:2}},

  // Tops — Oversized Drop Shoulder Tee (Amazon) x3
  {id:"hd1",name:"Mature Photo Tee",brand:"HILARYDUFF",color:"Black",size:"L",cat:"T-Shirt",type:"top",url:"https://shop.hilaryduff.com/products/mature-photo-tee",stats:{drama:1,structure:0,skin:0,edge:0,formality:1}},
  {id:"am1",name:"Oversized Drop Shoulder Tee Brown",brand:"AMAZON",color:"Brown",size:"L",cat:"T-Shirt",type:"top",url:"https://www.amazon.com/dp/B0GXDQ1J8N",stats:{drama:0,structure:0,skin:0,edge:0,formality:1}},
  {id:"am2",name:"Oversized Drop Shoulder Tee Blue",brand:"AMAZON",color:"Blue",size:"L",cat:"T-Shirt",type:"top",url:"https://www.amazon.com/dp/B0GXDQ1J8N",stats:{drama:0,structure:0,skin:0,edge:0,formality:1}},
  {id:"am3",name:"Oversized Drop Shoulder Tee Green",brand:"AMAZON",color:"Green",size:"L",cat:"T-Shirt",type:"top",url:"https://www.amazon.com/dp/B0GXDQ1J8N",stats:{drama:0,structure:0,skin:0,edge:0,formality:1}},
  {id:"am4",name:"Rhinestone Mesh Crop Shirt",brand:"AMAZON",color:"Black",size:"L",cat:"Shirt",type:"top",url:"https://www.amazon.com/dp/B0CDG4DY4H",stats:{drama:4,structure:0,skin:5,edge:2,formality:0}},
  {id:"am5",name:"Leather Body Chain Harness",brand:"AMAZON",color:"Black",size:"OS",cat:"Harness",type:"acc",url:"https://www.amazon.com/dp/B0BXT7V1SN",stats:{drama:4,structure:3,skin:5,edge:5,formality:0}},
  {id:"am6",name:"Patent Leather Chest Harness",brand:"AMAZON",color:"Black",size:"OS",cat:"Harness",type:"acc",url:"https://www.amazon.com/dp/B0CRP7D3B7",stats:{drama:4,structure:3,skin:5,edge:5,formality:0}},
  {id:"am7",name:"Cable Knit Sweater Vest Burgundy",brand:"AMAZON",color:"Burgundy",size:"S",cat:"Vest",type:"top",url:"https://www.amazon.com/dp/B0FHTQV7RM",stats:{drama:1,structure:1,skin:2,edge:0,formality:3}},
  {id:"am8",name:"Cable Knit Sweater Vest Apricot",brand:"AMAZON",color:"Apricot",size:"L",cat:"Vest",type:"top",url:"https://www.amazon.com/dp/B0DGXZBYCP",stats:{drama:1,structure:1,skin:2,edge:0,formality:3}},
  {id:"am9",name:"Fishnet Mock Neck Vest",brand:"AMAZON",color:"Black",size:"XL",cat:"Tank",type:"top",url:"https://www.amazon.com/dp/B0CT2NXSJ4",stats:{drama:3,structure:0,skin:5,edge:3,formality:0}},
  {id:"am10",name:"PU Leather Crop Tank",brand:"AMAZON",color:"Black",size:"XXL",cat:"Tank",type:"top",url:"https://www.amazon.com/dp/B0C22Z7XT9",stats:{drama:3.5,structure:2,skin:3,edge:4,formality:0}},
  {id:"am11",name:"PU Leather Shorts",brand:"AMAZON",color:"Black",size:"XXL",cat:"Shorts",type:"bottom",url:"https://www.amazon.com/dp/B0C22Z7XT9",stats:{drama:3,structure:2,skin:2,edge:3,formality:1}},
  {id:"am12",name:"Latex Hood Mask",brand:"AMAZON",color:"Black",size:"XL",cat:"Mask",type:"acc",url:"https://www.amazon.com/dp/B0FQV3N3KS",stats:{drama:5,structure:2,skin:0,edge:5,formality:0}},
  {id:"am13",name:"PU Leather Lace Up Crop Vest",brand:"AMAZON",color:"Black",size:"XL",cat:"Vest",type:"top",url:"https://www.amazon.com/dp/B0FHK64N8T",stats:{drama:3.5,structure:2,skin:3.5,edge:4,formality:0}},
  // ── ALO ──────────────────────────────────────────────────────────────────────
  {id:"al1",name:"Double Take Short Black",brand:"ALO",color:"Black",size:"M",cat:"Shorts",type:"bottom",style:"Dark / Minimal",url:"https://www.aloyoga.com/products/m6143r-7-double-take-short-black",stats:{drama:0,structure:1,skin:2,edge:0,formality:1}},
  {id:"al2",name:"Double Take Short Espresso",brand:"ALO",color:"Espresso",size:"M",cat:"Shorts",type:"bottom",style:"Tonal",url:"https://www.aloyoga.com/products/m6143r-7-double-take-short-espresso",stats:{drama:0,structure:1,skin:2,edge:0,formality:1}},
  // ── MUAZOE ───────────────────────────────────────────────────────────────────
  {id:"mz1",name:"Raye Print Round Neck T-shirt",brand:"MUAZOE",color:"Brown",size:"L",cat:"T-Shirt",type:"top",style:"Tonal",url:"https://www.muazoe.com/products/raye-print-round-neck-t-shirt-15",stats:{drama:1,structure:0,skin:0,edge:0,formality:1}},
  {id:"mz2",name:"Kanye West Print Round Neck T-shirt",brand:"MUAZOE",color:"Grey",size:"L",cat:"T-Shirt",type:"top",style:"Tonal",url:"https://www.muazoe.com/products/kanye-west-print-round-neck-t-shirt-20",stats:{drama:1,structure:0,skin:0,edge:0,formality:1}},
  {id:"u1",name:"Gold Dragon Cuff",brand:"UNBRANDED",color:"Gold",size:"OS",cat:"Cuff",type:"accessory",style:"Contrast",versatile:true,url:"https://www.ebay.com/itm/317008146557",stats:{drama:3,structure:1,skin:0,edge:3,formality:2}},
  {id:"dc1",name:"Neptune-210 Platform Boots",brand:"DEMONIA",color:"Black",size:"EU 44",cat:"Boots",type:"shoes",style:"Dark / Minimal",url:"https://demoniacult.com/products/neptune-210bvl",stats:{drama:5,structure:5,skin:0,edge:4.5,formality:1}},
];
